---
title: 昆士兰大学（University of Queensland, UQ）
parent: 澳洲
grand_parent: 学校课程图谱
nav_order: 5
permalink: /cs-courses/course-map/australia/uq/
...
- `COMP1100` — Introduction to Software Innovation
- `CSSE2002` — Programming in the Large
- `CSSE3012` — The Software Process
- `CSSE3200` — Software Engineering Studio: Design, Implement and Test
- `COMP3381` — International Software Development
...
- `INFS3204 / INFS7204` — Service-Oriented Architectures
