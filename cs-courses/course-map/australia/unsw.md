...
UNSW CS 采用 **COMP** 课程编码、每年 3 个 term（T1/T2/T3）快节奏授课。下方先给出**核心 / 高频课程详解**，再附**完整课程清单**。
...
> 更多核心课（如 `COMP9024`、`COMP9444` 深度学习、`COMP9517` 计算机视觉、`COMP3141`、`COMP1531` …）将按同样标准补充。想优先哪几门？→ [联系我](/contact/)。
