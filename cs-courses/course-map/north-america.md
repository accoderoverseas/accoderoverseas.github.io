...
nav_order: 1
permalink: /cs-courses/course-map/north-america/
published_at: "2026-07-05 15:54:23"
---

# 北美 · 学校课程图谱

按学校汇总 **北美** 地区热门且重要的 CS 课程。数据持续补充中，表格里「待补充」会逐步完善——也欢迎在 [联系我](/contact/) 时告诉我你的学校 / 课程，我可优先整理。
...
|---|---|---|---|---|---|---|
| （示例）MIT | 6.006 Introduction to Algorithms | 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |
| CMU | 15-213 CSAPP | 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |
| UC Berkeley | CS61B Data Structures | 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |
